...
//进阶装配机-等级2-普通巨构
Builder.start("advanced_assembler",32007)
    ...
    .withRecipeMap(FactoryRecipeMap.start("advanced_assembler")
            .maxInputs(9)
            .maxFluidInputs(3)
            .maxOutputs(1)
            .build()
...
//主方块配方
recipes.addShaped(<gregtech:machine:32007>,
    [[null,null,null],//
     [null,null,null],//
     [null,null,null]]//
);
...
//机器配方
//?
// RecipeMap.getByName("advanced_assembler").recipeBuilder()
//     .fluidInputs([])//
//     .fluidOutputs([])
//     .EUt()
//     .duration()
