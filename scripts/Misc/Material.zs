...
<material:neodymium_magnetic>.addFlags(["generate_fine_wire"]);//添加细磁化钕线
...
//32018 - 终极通用物质 - Ultimate Universal Matter
MaterialBuilder(32018,"ultimate_universal_matter")
    .fluid()
    .fluidTemp(32767)
    .color(0x330033)
    .build();
<material:ultimate_universal_matter>.setFormula("Uu", true);
